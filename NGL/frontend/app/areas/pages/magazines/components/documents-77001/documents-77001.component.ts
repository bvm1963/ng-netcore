...
@Component({
		...
		templateUrl: './documents-77001.component.html',
		styleUrls: ['./documents-77001.component.css'],
		encapsulation: ViewEncapsulation.None
})
export class Documents77001Component implements OnInit, OnDestroy {
		...
		getDocuments77001(id: number): void {
		...
		putDocuments77001(data: IDocumentsDepartment1[]): any {
				this.documentsDepartment1Service
